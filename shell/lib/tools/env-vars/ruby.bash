...
export PEMBA_PATHS_RUBY_HOME="${PEMBA_PATHS_HOME}/ruby"

require 'env-vars/bundle'

export RUBYOPT="-I${GEM_HOME}/gems/bundler-${BUNDLER_VERSION}/lib -rbundler/setup"
export RUBYOPT="$RUBYOPT -I${PEMBA_PATHS_RUBY_HOME}/common/lib -ropt/common"

export SSL_CERT_FILE="${PEMBA_PATHS_RUBY_HOME}/certs/cacert.pem"
